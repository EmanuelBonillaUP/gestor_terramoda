...
public class Dashboard extends JFrame {
    ...
    public Dashboard(String uriClient) {
        ...
        panelAuth.setLayout(new BoxLayout(panelAuth, BoxLayout.Y_AXIS));

        JPanel voidLabel = new JPanel();
        voidLabel.setBorder(new EmptyBorder(100, 0, 0, 0));
        voidLabel.setBackground(Color.white);

        JLabel userTextLabel = new JLabel("Usuario");
        userTextLabel.setBackground(Color.WHITE);
        userTextLabel.setFont(new Font(font(), Font.BOLD, fontTitleSize()));

        JTextField userTextField = new JTextField("admin_terramoda_123", 15);
        JLabel passTextLabel = new JLabel("Contraseña");
        passTextLabel.setFont(new Font(font(), Font.BOLD, fontTitleSize()));
        passTextLabel.setBackground(Color.WHITE);
        JTextField passTextField = new JTextField("pass_super_secret_xd", 15);
        panelAuth.add(voidLabel, BorderLayout.CENTER);
        panelAuth.add(userTextLabel, BorderLayout.CENTER);
        panelAuth.add(userTextField, BorderLayout.CENTER);
        panelAuth.add(passTextLabel, BorderLayout.CENTER);
        panelAuth.add(passTextField, BorderLayout.CENTER);
        btnAcceder.addActionListener(s -> {
            var data = new Login();
            data.user = userTextField.getText();
            data.pass = passTextField.getText();
            try {
                client.login(data);
    ...
    JPanel panelProductEdit(Product v) {
        ...
        btnEdit.addActionListener(l -> {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(p, "Error Stock o Price no son valores numericos validos", "Error Editando Producto", JOptionPane.ERROR_MESSAGE);
                return;
            }
            if (stock < 0 || price <= 0) {
                JOptionPane.showMessageDialog(p, "Error Stock o Price no son valores validos", "Error Editando Producto", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            try {
                ...
                System.out.println(e);
                JOptionPane.showMessageDialog(p, "Error editando producto", "Error Editando Producto", JOptionPane.ERROR_MESSAGE);
            }
        });
        return p;
    }
    ...
    JPanel panelProducts(int page, int per_page) {
        ...
        try {
            ...
            var pnlInformation = panelTableInformation(result, page, per_page, (new_page, new_per_page) -> panelProducts(new_page, new_per_page));
    ...
    JPanel panelProductRegister() {
        ...
        btnRegister.addActionListener(l -> {
            ...
            try {
                ...
                System.out.println(e);
                JOptionPane.showMessageDialog(p, "Error Registrando producto", "Error Registrando Producto", JOptionPane.ERROR_MESSAGE);
            }
        });
        return p;
    }
    ...
    JPanel panelCustomerEdit(Customer e) {
        ...
        btnEdit.addActionListener(l -> {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(p, "Error Editando el cliente", "Error Editando Cliente", JOptionPane.ERROR_MESSAGE);
            }
        });
    ...
    JPanel panelCustomers(int page, int per_page) {
        ...
        try {
            ...
            var pnlInformation = panelTableInformation(result, page, per_page, (new_page, new_per_page) -> panelCustomers(new_page, new_per_page));
    ...
    JPanel panelCustomerRegister() {
        ...
        btnRegister.addActionListener(l -> {
            ...
            try {
                ...
                System.out.println(e);
                JOptionPane.showMessageDialog(p, "Error Registrando el cliente", "Error Registrando Cliente", JOptionPane.ERROR_MESSAGE);
            }
        });
    ...
    <T> JPanel panelTableInformation(PaginationResult<T> pagination, int page, int per_page, BiFunction<Integer, Integer, JPanel> getPanel) {
        var p = new JPanel();
...
// --- Agregar todo al panel principal ---
    ...
    private JPanel panelSales(int page, int per_page) {
        ...
        try {
            ...
            var pnlInformation = panelTableInformation(sales, page, per_page, (new_page, new_per_page) -> panelSales(new_page, new_per_page));
    ...
    private JPanel panelSaleRegister() {
        ...
        btnRegister.addActionListener(e -> {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(panelProduct, "Error Inesperado\nPosible Cedula o SKU Invalido", "Error Registrando Venta", JOptionPane.ERROR_MESSAGE);
            }
        });
